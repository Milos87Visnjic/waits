...
public class PlayerAccountStepDefs {
    ...
    public void user_clicks_on_avatar() throws InterruptedException {
        playerAccountPage.clickAvatar();
    }

    @When("User clicks on Player Account button")
    public void userClicksOnPlayerAccountButton() throws InterruptedException {
    ...
    public void userClicksOnContactUs() {
        playerAccountPage.clickOnContactUs();
    }

    @When("User clicks on Report an issue")
    public void userClicksOnReportAnIssue() throws InterruptedException {
        playerAccountPage.clickOnReportAnIssue();
    }

    @Then("User reports a bug on website")
    public void userReportsABugOnWebsite() throws InterruptedException {
        playerAccountPage.reportBug();
    }
